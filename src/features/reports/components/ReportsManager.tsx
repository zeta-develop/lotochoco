            ...
            <>
              <div className="bg-primary p-6 text-white shrink-0">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <Button variant="ghost" size="icon" className="text-white hover:bg-white/10 rounded-full" onClick={() => setIsTicketDialogOpen(false)} aria-label="Cerrar diálogo"><X className="h-5 w-5"/></Button>
                </div>
