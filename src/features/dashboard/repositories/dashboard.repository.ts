...
export class DashboardRepository {
  async getDailyStats(startDate: Date, endDate: Date): Promise<DashboardStats> {
    try {
      // Intentar usar el RPC optimizado
      ...
      console.warn('RPC get_sales_report no disponible en Dashboard, usando fallback:', err)
    }

    // FALLBACK: Lógica manual (Surgical selection)
