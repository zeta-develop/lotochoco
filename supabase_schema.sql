...
CREATE INDEX IF NOT EXISTS idx_results_company_id ON public.results(company_id);
...
-- Políticas Results (Aisladas por company_id para mayor seguridad y rendimiento)
