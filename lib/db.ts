    ...
    try {
      ...
      if (!tableCheck.values || tableCheck.values.length === 0) {
        ...
        const statements = [
          ...
          `CREATE TABLE IF NOT EXISTS "Ticket" ("id" TEXT PRIMARY KEY, "ticketNumber" TEXT UNIQUE, "client" TEXT, "totalAmount" REAL, "status" TEXT DEFAULT 'active', "cancelReason" TEXT, "cancelledAt" DATETIME, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME);`,
          `CREATE TABLE IF NOT EXISTS "TicketItem" ("id" TEXT PRIMARY KEY, "ticketId" TEXT, "gameId" TEXT, "number" TEXT, "amount" REAL, "schedule" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME, FOREIGN KEY ("ticketId") REFERENCES "Ticket" ("id") ON DELETE CASCADE, FOREIGN KEY ("gameId") REFERENCES "Game" ("id"));`,
          ...
          `CREATE TABLE IF NOT EXISTS "CashMovement" ("id" TEXT PRIMARY KEY, "cashSessionId" TEXT, "type" TEXT, "amount" REAL, "description" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME, FOREIGN KEY ("cashSessionId") REFERENCES "CashSession" ("id") ON DELETE CASCADE);`,
          `CREATE TABLE IF NOT EXISTS "Setting" ("id" TEXT PRIMARY KEY, "key" TEXT UNIQUE, "value" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME);`,
          `CREATE TABLE IF NOT EXISTS "CancellationLog" ("id" TEXT PRIMARY KEY, "ticketId" TEXT, "ticketNumber" TEXT, "totalAmount" REAL, "reason" TEXT, "itemsJson" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME);`,
          `CREATE TABLE IF NOT EXISTS "AppErrorLog" ("id" TEXT PRIMARY KEY, "severity" TEXT DEFAULT 'error', "source" TEXT, "message" TEXT, "stack" TEXT, "details" TEXT, "url" TEXT, "userAgent" TEXT, "platform" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME);`,
        ...
        try {
          ...
          await db.execute(`ALTER TABLE "Game" ADD COLUMN "isDirty" INTEGER DEFAULT 0;`).catch(() => {});
          await db.execute(`ALTER TABLE "Game" ADD COLUMN "deletedAt" DATETIME;`).catch(() => {});

          await db.execute(`ALTER TABLE "DrawSchedule" ADD COLUMN "isDirty" INTEGER DEFAULT 0;`).catch(() => {});
          await db.execute(`ALTER TABLE "DrawSchedule" ADD COLUMN "deletedAt" DATETIME;`).catch(() => {});

          await db.execute(`ALTER TABLE "Result" ADD COLUMN "isDirty" INTEGER DEFAULT 0;`).catch(() => {});
          await db.execute(`ALTER TABLE "Result" ADD COLUMN "deletedAt" DATETIME;`).catch(() => {});

          await db.execute(`CREATE TABLE IF NOT EXISTS "AppErrorLog" ("id" TEXT PRIMARY KEY, "severity" TEXT DEFAULT 'error', "source" TEXT, "message" TEXT, "stack" TEXT, "details" TEXT, "url" TEXT, "userAgent" TEXT, "platform" TEXT, "createdAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP, "isDirty" INTEGER DEFAULT 1, "deletedAt" DATETIME);`).catch(() => {});
          ...
          // Nuevas migraciones para soporte offline-first
          const tablesToMigrate = ['Ticket', 'TicketItem', 'Winner', 'CashSession', 'CashMovement', 'Setting', 'CancellationLog', 'AppErrorLog'];
          for (const table of tablesToMigrate) {
            await db.execute(`ALTER TABLE "${table}" ADD COLUMN "updatedAt" DATETIME DEFAULT CURRENT_TIMESTAMP;`).catch(() => {});
            await db.execute(`ALTER TABLE "${table}" ADD COLUMN "isDirty" INTEGER DEFAULT 0;`).catch(() => {});
            await db.execute(`ALTER TABLE "${table}" ADD COLUMN "deletedAt" DATETIME;`).catch(() => {});
          }
