  ...
  return (
    <div className="space-y-8 pb-24 max-w-4xl mx-auto">
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="rounded-3xl border-none shadow-2xl sm:max-w-md p-0 text-center">
          <DialogTitle className="sr-only">Venta Exitosa</DialogTitle>
          <div className="bg-green-500/10 p-4 border-b border-green-500/10 flex flex-col items-center justify-center gap-1.5">
            ...
            <DialogHeader className="text-center">
              <DialogTitle className="text-lg font-black uppercase tracking-tighter text-green-700 dark:text-green-400">¡Venta Exitosa!</DialogTitle>
              <DialogDescription className="text-[10px] font-bold uppercase tracking-widest mt-0.5">El ticket se generó en la base de datos.</DialogDescription>
            </DialogHeader>
          </div>

          {lastTicket && (
            <div className="px-4 pt-4">
              {/* Factura completa (formato boleto) — compacta, hasta 15 jugadas sin scroll */}
          ...
          <div className="p-4 bg-background">
            <DialogFooter className="flex-col gap-2 sm:flex-row sm:gap-2">
              <Button variant="outline" onClick={() => setShowSuccessDialog(false)} className="w-full sm:w-1/3 h-10 rounded-xl font-black uppercase text-[10px] border-2">
                Cerrar
              </Button>
              <Button variant="secondary" onClick={handleShare} className="w-full sm:w-1/3 h-10 rounded-xl font-black uppercase text-[10px] bg-blue-500/10 text-blue-700 hover:bg-blue-500/20">
                <Share2 className="mr-2 h-4 w-4" />
                Compartir
              </Button>
              <Button onClick={handlePrint} className="w-full sm:w-1/3 h-10 rounded-xl font-black uppercase text-[10px] shadow-lg">
